...
pub fn carousel() -> Html {
    let slides = vec![
        (
            "images/image4.png",
            "Recupérate en Casa, Rodeado de los Tuyos",
            "Recibir atención médica de calidad no significa tener que dejar tu hogar. Nuestro equipo certificado llega hasta donde estás para que te recuperes donde más importa.",
            "Ver Nuestros Servicios",
            "#servicios",
        ),
        (
            "images/image5.png",
            "Tu Medicare lo Cubre — Sin Costo Adicional",
            "Si eres beneficiario de Medicare o Medicare Advantage, nuestros servicios pueden estar completamente cubiertos. Nosotros nos encargamos de la facturación por ti.",
            "¿Calificas? Descúbrelo",
            "#requisitos",
        ),
        (
            "images/image6.png",
            "Un Equipo Experto, En Tu Hogar",
            "Enfermeras, terapistas, trabajadores sociales y nutricionistas certificados — todos coordinados para darte el cuidado integral que mereces, donde vives.",
            "Contáctanos Hoy",
            "#contacto",
        ),
    ];
